                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $resultado = mysqli_query($conexao, "SELECT * from closed_os where cliente like '%$filtro%' order by id DESC");
                                ...
                                while ($linha = mysqli_fetch_array($resultado)) {
                                    ...
                                    $usuario = $linha["usuario"]; // Assumindo que você tem uma coluna "usuario" na tabela "os".
