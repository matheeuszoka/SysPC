            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Nova Manutenção</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="./PHP/insercao/insere_manutencao.php" method="post">
                                <!-- Entidade -->
                                <div class="form-group">
                                    ...
                                    include("./PHP/conexao.php");
                                        $result = mysqli_query($conexao, "select * from entidade");
                                        while ($raw = mysqli_fetch_array($result)) {
                                            $entidade = $raw["entidade"];
                                            echo "<option value='$entidade'>$entidade</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="setor" name="setor" required>
                                        ...
                                        <?php
                                    include("./PHP/conexao.php");
                                        $result = mysqli_query($conexao, "select * from setor");
                                        while ($raw = mysqli_fetch_array($result)) {
                                            $setor = $raw["setor"];
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dataEntrada" name="data" required>
                                </div>
                                <!-- senha -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="problema" name="problema" rows="1"
                                        placeholder="Descreva o problema" required></textarea>
                                </div>
                                <input type="hidden" name="status" value="Em Processo">
                                <!-- Botão de Submissão -->
                                <button type="submit" class="btn btn-primary">Adicionar OS</button>
                            </form>
                        </div>
                    </div>
