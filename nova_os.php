            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Nova OS</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="./PHP/insercao/insere_os.php" method="post">
                                <!-- Cliente -->
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="problema" name="problema" rows="1" placeholder="Descreva o problema" required></textarea>
                                </div>
