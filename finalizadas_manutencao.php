                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Ordens de Serviço finalizadas.</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $resultado = mysqli_query($conexao, "SELECT * from closed_manutencao order by id DESC ");
                                        ...
                                        while ($linha = mysqli_fetch_array($resultado)) {
                                            ...
                                            if ($status != "Em processo") {
                                                echo '<tr>
                                                  ...
                                                  <td>' . $senha . '</td>
                                                  <td>  
                                                  <a class="btn btn-success btn-sm" href="./PHP/relatorio.php?id=' . $id . '" title="Finalizar"target=_blank><i class="fas fa-file-alt"></i></a>
                                                  </td>
                                              </tr>';
                                            }
                                        }
