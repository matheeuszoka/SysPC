            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cadastro de Entidades.</h1>
                    </div>

                    <!-- Formulário para Nova OS -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">informações sobre a entidade.</h6>
                        </div>
                        <div class="card-body">
                            <form action="./PHP/insercao/insere_entidade.php" method="post">
                                <!-- Cliente -->
                                <div class="form-group">
                                    <label for="cliente">Entidade:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="resAtual" name="resAtual" placeholder="Informe o Responsável" >
                                </div>
