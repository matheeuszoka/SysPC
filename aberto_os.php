...
<body id="page-top">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $resultado = mysqli_query($conexao, "SELECT * from os where cliente like '%$filtro%' order by id");
                                        ...
                                        while ($linha = mysqli_fetch_array($resultado)) {
                                            ...
                                            $data = $linha["data"];
                                            $saida = $linha["previsao"];
                                            $senha = $linha["senha"];
                                            $problema = $linha["problema"];
                                            $usuario = $linha["user"]; // Assumindo que você tem uma coluna "usuario" na tabela "os".
                                            $status = $linha["status"]; // Assumindo que você tem uma coluna "usuario" na tabela "os".
                                            $data_formatada = date("d/m/Y", strtotime($data));
                                            $saida_formatada = date("d/m/Y", strtotime($saida));
    ...
    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
        ...
        <a class="dropdown-item" href="./PHP/os_print.php?id=' . $id . '"target=_blank>Recibo</a>
        <a class="dropdown-item" href="finalizar_os.php?id=' . $id . '">Finalizar</a>
        <a class="dropdown-item" data-id="' . $id . '" onclick="showConfirmationModal(this);" title="Excluir">Excluir</a>
        </div>
</div>
                                              </tr>';
                                            }
