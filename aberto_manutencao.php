                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $resultado = mysqli_query($conexao, "SELECT * from contratos where entidade like '%$filtro%' order by id");
                                        ...
                                        while ($linha = mysqli_fetch_array($resultado)) {
                                            ...
                                            if ($status != "Finalizada") {
                                                echo '<tr>
                                                  ...
                                                  <td>' . $problema . '</td>
                                                  <td>  
                                                  <a class="btn btn-success btn-sm" href="finalzar_manutencao.php?id=' . $id . '" title="Finalizar"><i class="fas fa-pen"></i></a>
                                                  <a class="btn btn-danger btn-sm" href="./PHP/exclusoes/excluir_manutencao.php?id=' . $id . '" title="Excluir"><i class="fas fa-trash-alt"></i></a>
                                                  </td>
                                              </tr>';
                                            }
                                        }
