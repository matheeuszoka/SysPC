            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Editar OS</h1>
                    </div>
                    <?php
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="./PHP/alterar/altera_os.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="telefone" name="telefone" value="<?php echo $raw['telefone']; ?>" placeholder="(00) 00000-0000" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dataEntrada" name="data"value="<?php echo $raw['data']; ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="senha" name="senha" value="<?php echo $raw['senha']; ?>"placeholder="Digite a senha">
                                </div>

                                <!-- Problema -->
                                <div class="form-group">
                                    <label for="problema">Problema:</label>
                                    <input type="text" class="form-control" id="problema" name="problema" rows="1" value="<?php echo $raw['problema']; ?>"placeholder="Descreva o problema" required></input>
                                </div>
                                <input type="hidden" name="status" value="Em Processo">
