                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">informações sobre a Setor.</h6>
                        </div>
                        <div class="card-body">
                            <form action="./PHP/insercao/insere_setor.php" method="post">
                                <!-- Cliente -->
                                <div class="form-group">
                                    <label for="cliente">Setor:</label>
                                    <input type="text" class="form-control" id="entidade" name="setor"
                                ...
                                <!-- Senha -->
                                <div class="form-group">
                                    <label for="senha">Responsável Atual:</label>
                                    <input type="text" class="form-control" id="resAtual" name="resAtual"
