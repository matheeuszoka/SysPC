                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Editar Ordem de Serviço!</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $resultado = mysqli_query($conexao, "SELECT * from os where cliente like '%$filtro%' order by id DESC");
                                        ...
                                        while ($linha = mysqli_fetch_array($resultado)) {
                                            ...
                                            $saida_formatada = date("d/m/Y", strtotime($saida));
                                                ...
                                                echo '<tr>
                                                  ...
                                                  <td>'.$problema.'</td>
                                                  <td>  
                                                  <a class="btn btn-success btn-sm" href="editar_os.php?id=' . $id . '" title="Finalizar"><i class="fas fa-pen"></i></a>
                                                  </td>
                                              </tr>';
